...
OR (f.id IN(59,61,63,64,65,66,67));
...
OR (f.id >= 40 AND f.id <= 44) OR (f.id IN(60,62));
...
OR f.id = 39 OR (f.id >= 52 AND f.id <= 58) OR (f.id IN(60,62));
...
inner join employee e on e.department_id IN (5)
left join user u on u.employee_id = e.id
where (f.id >= 48 AND f.id <= 51) OR (f.id IN(60,62));
