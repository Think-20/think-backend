...
use App\FinanceiroFile;

class FinanceiroFileController extends Controller
{
    public static function save(Request $request)
    {
        ...
        try {
            $project_file = FinanceiroFile::insert($data);
    ...
    public static function saveMultiple(Request $request)
    {
        ...
        try {
            $projectFiles = FinanceiroFile::insertAll($data);
    ...
    public static function edit(Request $request)
    {
        ...
        try {
            $project_file = FinanceiroFile::edit($data);
    ...
    public static function remove(int $id)
    {
        ...
        try {
            $project_file = FinanceiroFile::remove($id);
    ...
    {
        try {
            $fileFound = FinanceiroFile::downloadFile($id);
            $status = true;
    ...
    {
        try {
            $fileFound = FinanceiroFile::downloadAllFiles($taskId);
            $status = true;
            return Response::make(file_get_contents($fileFound), 200, ['Content-Type' => mime_content_type($fileFound)]);
        } catch (Exception $e) {
            $message = 'Um erro ocorreu ao abrir o arquivo: ' . $e->getMessage();
