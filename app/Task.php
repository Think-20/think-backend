...
class Task extends Model
{
    ...
    public static function editValues($data)
    {
        ...
        //isset($data['orders_value']) /*|| $data['orders_value'] == ""*/ ? $task->orders_value = $data['orders_value'] : null;  //Descontinuado
        //isset($data['attendance_value']) /*|| $data['attendance_value'] == ""*/ ? $task->attendance_value = $data['attendance_value'] : null; //Descontinuado
        //isset($data['creation_value']) /*|| $data['creation_value'] == "" */ ? $task->creation_value = $data['creation_value'] : null;  //Descontinuado
        //isset($data['pre_production_value']) /*|| $data['pre_production_value'] == ""*/ ? $task->pre_production_value = $data['pre_production_value'] : null;  //Descontinuado
        //isset($data['production_value']) /*|| $data['production_value'] == "" */ ? $task->production_value = $data['production_value'] : null;  //Descontinuado
        //isset($data['details_value']) /*|| $data['details_value'] == "" */ ? $task->details_value = $data['details_value'] : null;  //Descontinuado
        //isset($data['budget_si_value']) /*|| $data['budget_si_value'] == "" */ ? $task->budget_si_value = $data['budget_si_value'] : null;  //Descontinuado
        //isset($data['bv_value']) /*|| $data['bv_value'] == "" */ ? $task->bv_value = $data['bv_value'] : null;  //Descontinuado
        //isset($data['over_rates_value']) /*|| $data['over_rates_value'] == ""*/ ? $task->over_rates_value = $data['over_rates_value'] : null;  //Descontinuado
        //isset($data['discounts_value']) /*|| $data['discounts_value'] == "" */ ? $task->discounts_value = $data['discounts_value'] : null;  //Descontinuado
        //isset($data['taxes_value']) /*|| $data['taxes_value'] == "" */ ? $task->taxes_value = $data['taxes_value'] : null;  //Descontinuado
        //isset($data['logistics_value']) /*|| $data['logistics_value'] == ""*/ ? $task->logistics_value = $data['logistics_value'] : null;  //Descontinuado
        //isset($data['equipment_value']) /*|| $data['equipment_value'] == "" */ ? $task->equipment_value = $data['equipment_value'] : null;  //Descontinuado
        //isset($data['total_cost_value']) /*|| $data['total_cost_value'] == "" */ ? $task->total_cost_value = $data['total_cost_value'] : null;  //Descontinuado
        //isset($data['gross_profit_value']) /*|| $data['gross_profit_value'] == ""*/ ? $task->gross_profit_value = $data['gross_profit_value'] : null;  //Descontinuado
        //isset($data['profit_value']) /*|| $data['profit_value'] == ""*/ ? $task->profit_value = $data['profit_value'] : null;  //Descontinuado
        ...
        isset($data['material_mezanino']) /*|| $data['final_value'] == ""*/ ? $task->material_mezanino = $data['material_mezanino'] : null;
        isset($data['fechamento_vidro']) /*|| $data['final_value'] == ""*/ ? $task->fechamento_vidro = $data['fechamento_vidro'] : null;
        isset($data['vitrines']) /*|| $data['final_value'] == ""*/ ? $task->vitrines = $data['vitrines'] : null;
        isset($data['acrilico']) /*|| $data['final_value'] == ""*/ ? $task->acrilico = $data['acrilico'] : null;
        isset($data['mobiliario']) /*|| $data['final_value'] == ""*/ ? $task->mobiliario = $data['mobiliario'] : null;
        isset($data['refrigeracao_climatizacao']) /*|| $data['final_value'] == ""*/ ? $task->refrigeracao_climatizacao = $data['refrigeracao_climatizacao'] : null;
        isset($data['paisagismo']) /*|| $data['final_value'] == ""*/ ? $task->paisagismo = $data['paisagismo'] : null;
        isset($data['comunicacao_visual']) /*|| $data['final_value'] == ""*/ ? $task->comunicacao_visual = $data['comunicacao_visual'] : null;
    ...
    public function contract_nf_files()
    {
        return $this->hasMany('App\ContractNfFile', 'task_id');
    }

    public function financeiro_files()
    {
        return $this->hasMany('App\FinanceiroFile', 'task_id');
    }
