...
class ProjectPhotos extends Model
{
    ...
    protected $table = 'project_photos_file';
    protected $fillable = [
        'task_id',
        'responsible_id',
        'name',
    ...
    {
        $browserFiles = [];
        $path = env('FILES_FOLDER') . '/project-photos-files';
    ...
    public static function downloadFile($id)
    {
        ...
        $projectFile = ProjectPhotos::find($id);
        ...
        $pathFile = env('FILES_FOLDER') . '/project-photos-files/' . $name;
    ...
    {
        $projectFiles = ProjectPhotos::where('task_id', '=', $taskId)->get();
        $zip = new ZipArchive;
    ...
    public static function insertAll(array $data)
    {
        ...
        foreach ($data as $projectFile) {
            $project_files[] = ProjectPhotos::insert($projectFile);
        }
    ...
    public static function insert(array $data)
    {
        ...
        $project_file = new ProjectPhotos(array_merge($data, [
